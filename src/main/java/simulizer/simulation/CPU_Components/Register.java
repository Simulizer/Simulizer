...
public class Register extends Observable {
	...
	/** doesn't really 'send' anything but puts something in the LSBus to be retrieved by the LSUnit */
	...
	/** this method retrieves the contents sent to it from the ALU in the bus connecting the ALU and register */
	...
	/** method retrieves the contents sent to it from the control unit using the bus connecting the two */
	...
	/** this method 'sends' something on the control bus so that it can be retrieved by the control unit */
