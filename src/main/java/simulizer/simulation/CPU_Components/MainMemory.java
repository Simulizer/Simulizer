...
/**this class represents the RAM of our simulator
 * it is represented via a large Word array, which will be partitioned
 * this memory has the absence of OS reserved data (which we don't need)
 * the stack is also represented in a different data structure
 * @author Charlie Street
 *
 */
public class MainMemory extends Observable
{
	private final int MEM_SIZE;//the size of the memory we are allowing (standard is 4mb worth of words)
	private Word[] RAM;
