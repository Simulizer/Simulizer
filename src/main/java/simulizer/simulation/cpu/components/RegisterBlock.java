...
/**
 * this class represents the entire block of general purpose registers there are
 * 32 of these registers
 * 
...
public class RegisterBlock extends Observable {
	...
	/**
	 * constructor will initialise the buses and call for the registers to be
	 * set up
	 * 
	 * @param lsUnit
	 *            the bus connecting the register block and the LS unit
	 * @param ALU
	 *            the bus between the ALU and the register block
	 * @param controlUnit
	 *            the bus connecting the register block and the control unit
	 */
	 ...
	 *            the register index
	 * @param word
	 *            the word to insert into that register
	 */
