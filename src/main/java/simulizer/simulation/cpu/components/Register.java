...
public class Register {
	 ...
	 * 
	 * @param pseudonym
	 *            the pseudonym given to this register
	 */
	...
	/**
	 * this method sets new data into the register, to be careful it is
	 * synchronised for exclusive access to prevent any possible errors that may
	 * occur due to multi threading and the pipelining
	 * 
	 * @param word
	 *            the word to set in the register
	 */
