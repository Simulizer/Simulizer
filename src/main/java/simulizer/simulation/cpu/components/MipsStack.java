...
/**representing a stack of word objects for our memory representation
 * no real need for a stack pointer since the built in Java stack object deals
 * with this itself (the sp register can somehow link us to the object of this class
