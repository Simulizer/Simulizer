...
public class CPU {
    ...
    public void drawCPU(){
        ...
        Wire controlUnitToIM1 = instructionMemory.verticalLineTo(controlUnit, true, true, -10);
        Wire controlUnitToIM2 = instructionMemory.verticalLineTo(controlUnit, true, false, 10);
